...
const CATEGORIES: CategoryDef[] = [
  {
    id: "coffee",
    voiceLabel:
      "첫 번째, 커피 카테고리예요. 아메리카노, 카페라떼, 카푸치노가 있어요. 두 번 두드리면 선택돼요.",
  ...
  },
  {
    id: "ade",
    voiceLabel:
      "두 번째, 에이드 카테고리예요. 레몬에이드, 자몽에이드가 있어요. 두 번 두드리면 선택돼요.",
  ...
  },
  {
    id: "tea",
    voiceLabel:
      "세 번째, 티 카테고리예요. 캐모마일, 페퍼민트 차가 있어요. 두 번 두드리면 선택돼요.",
  ...
  },
  {
    id: "dessert",
    voiceLabel:
      "네 번째, 디저트 카테고리예요. 크로와상이 있어요. 두 번 두드리면 선택돼요.",
